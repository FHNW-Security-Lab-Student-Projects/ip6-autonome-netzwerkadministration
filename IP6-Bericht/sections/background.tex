...
sequence of steps, an AI Agent instead responds to what it observes while running,
...
a smaller selection of tools, which keeps its individual context small and reduces the risk of context-related
quality degradation.
...
harness is most of the time provided by an \emph{agent framework} with APIs to modify and add additional functionality. The concrete framework used in this work is described in
