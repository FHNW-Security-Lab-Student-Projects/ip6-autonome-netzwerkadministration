...
Most of these faults fall into a few recurring type of faults: link and hardware failures, such as a disabled
interface or a broken uplink, misconfigurations such as a VLAN missing
from a trunk, an overly strict access control list, a faulty routing policy, a
duplicate IP address or a mismatched MTU. What makes these faults hard and time consuming to
diagnose is their visibility. Some show themselves in
the logs and are found with a single show command, while others are very hard to find
and only show themselves once or need correlation of multiple show commands.
This is what makes some problems take minutes of work and others hours.
...
them with respect to the research questions and discusses the limitations.
