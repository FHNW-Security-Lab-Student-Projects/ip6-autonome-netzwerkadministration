...
\begin{itemize}
    ...
    \item \textbf{Claude Code / Claude AI}: programming, docs / readme in repo, templating, text editing, rephrasing and drafting assistance in parts of the report, grammar and spelling corrections, research.
