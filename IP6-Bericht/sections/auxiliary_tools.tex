...
\begin{itemize}
    ...
    \item \textbf{Claude Code / Claude AI} -- programming, templating, text editing, rephrasing and drafting assistance in parts of the report, grammer and spelling mistakes, research.
